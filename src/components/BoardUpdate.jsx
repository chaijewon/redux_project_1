...
import {boardReset, boardUpdate, boardUpdateOk} from "../actions/boardActions";
...
function BoardUpdate(){
    ...
    const update=()=>{
        ...
        dispatch(boardUpdateOk(params)) // insert
    }
                ...
                <table className="table table-striped">
                    ...
                    <tr>
                        <td className={"text-center"} colSpan={2}>
                            ...
                            <button className={"btn btn-sm btn-primary"} onClick={cancel}>취소</button>
                        </td>
                    </tr>
                    </tbody>
                </table>
